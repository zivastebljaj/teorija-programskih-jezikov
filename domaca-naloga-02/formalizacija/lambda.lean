...
begin
    ...
    case step.list_match_cons {
        ...
        apply substitution, apply weakening, 
        assumption, assumption,
    }
end
...
begin
  ...
  case of.cons {
    ...
    cases h, right, existsi _, 
    apply step.cons1, assumption,
  },
  case of.list_match{
    cases H_ih_a empty,
    case or.inl{
      ...
      case of.nil {
         existsi H_e1, apply step.list_match_nil
      },
      case of.cons {
        existsi _, apply step.list_match_cons,
      },
      repeat {cases h},
    },
  case or.inr{
